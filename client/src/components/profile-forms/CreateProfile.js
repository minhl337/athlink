    ...
    return (
      ...
      <form className="form" onSubmit={e=>onSubmit(e)}>
        ...
        {displaySocialInputs && <Fragment>
          ...
          <input type="text" placeholder="https://twitter.com/YOURACCOUNT" name="twitter" value={twitter} onChange={e=>onChange(e)}/>
        </div>

        <div className="form-group social-input">
          <i className="fab fa-facebook fa-2x"></i>
          <input type="text" placeholder="https://www.facebook.com/YOURACCOUNT" name="facebook" value={facebook} onChange={e=>onChange(e)}/>
        </div>

        <div className="form-group social-input">
          <i className="fab fa-youtube fa-2x"></i>
          <input type="text" placeholder="https://www.youtube.com/user/YOURACCOUNT" name="youtube" value={youtube} onChange={e=>onChange(e)}/>
        </div>
        ...
        <div className="form-group social-input">
          ...
          <input type="text" placeholder="https://www.instagram.com/YOURACCOUNT" name="instagram" value={instagram} onChange={e=>onChange(e)}/>
        </div>
        </Fragment>}
